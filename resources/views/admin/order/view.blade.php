                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="statusForm" action="{{ route('order.changestatus', ['id' => $orders->id]) }}"
                                        method="POST">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="status" name="status">
                                                ...
                                                <option value="1" {{ $orders->status == 1 ? 'selected' : '' }}>
                                                    Confirmed</option>
                                                <option value="2" {{ $orders->status == 2 ? 'selected' : '' }}>Shipped
                                                </option>
                                                <option value="3" {{ $orders->status == 3 ? 'selected' : '' }}>Out for
                                                    Delivery</option>
                                                <option value="4" {{ $orders->status == 4 ? 'selected' : '' }}>
                                                    Delivered</option>
                                            </select>
