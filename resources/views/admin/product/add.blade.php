                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_product_scroll">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <textarea name="basic_description"
                                class="form-control form-control-solid mb-3 mb-lg-0 @error('basic_description') is-invalid @enderror" rows="3"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <textarea name="full_description"
                                class="form-control form-control-solid mb-3 mb-lg-0 @error('full_description') is-invalid @enderror" rows="5"
